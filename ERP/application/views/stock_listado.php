                            ...
                            <table class="table table-data2" id="table2excel">
                                ...
                                <tbody>
                                    <tr class="tr-shadow" v-for="(stock, index) in buscarStock">
                                        ...
                                        <td>
                                            <h3 class="text-info" align="center">${{stock.Precio * stock.Cant_actual | Moneda}}</h3>
                                        </td>
                ...
                <form class="form-horizontal" action="post" v-on:submit.prevent="movimientoStock_v2()">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="egresoDato.Orden_trabajo_id" required>
                                <option value="0">No vincular a ninguna orden</option>
                                <option v-for="orden in listaOrdenes" v-bind:value="orden.Id">{{orden.Nombre_producto}} para {{orden.Nombre_cliente}}, fabrica {{orden.Nombre_usuario}}</option>
                            </select>
                        </div>
                        <div class="horizontal-form">
                            <div class="form-group">
