    ...
    <div class="main-content" id="dashboard">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                        ...
                        <div class="overview-item overview-item--c4">
                            <div class="overview__inner">
                                <div class="overview-box clearfix">
                                    ...
                                    <div class="text">
                                        <h2>{{cantOrdenesTrabajo}}</h2>
                                        <span>Ord.trabajo finalizadas este año</span>
                                    </div>
                                </div>
                                <div class="overview-chart">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="title-1 m-b-25">Ordenes de trabajo en proceso</h2>
                            ...
                            <table class="table table-borderless table-striped table-earning">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Días estimados para finalizar</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="orden in listaOrdenes">
                                        ...
                                        <td>{{diferenciasEntre_fechas(null, orden.Fecha_estimada_finalizacion)}}</td>
                                        <td>
                                            <a class="item" v-bind:href="'ordentrabajo/datos/?Id='+orden.Id" title="Ver orden">
