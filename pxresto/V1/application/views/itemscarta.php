    ...
    <div class="content-wrap" id="app">
                        ...
                        <div class="horizontal-form">
                            ...
                            <form class="form-horizontal" action="post" v-on:submit.prevent="crearItem()">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" v-model="itemCarta.Precio_costo" required>
                                    </div>
                                    ...
                                    <label class="col-sm-12 control-label">Apto stockeo (Requerido)</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group" v-show="itemCarta.Apto_stock == 1">
                                    <label v-if="itemCarta.Id == null" class="col-sm-12 control-label">Cantidad actual</label>
                                    <div v-if="itemCarta.Id == null" class="col-sm-12">
                                        <input type="number" class="form-control" v-model="itemCarta.Cant_actual">
                                    </div>
                                </div>
                                <div class="form-group" v-show="itemCarta.Apto_stock == 1">
                                    <label v-if="itemCarta.Id == null" class="col-sm-12 control-label">Cantidad ideal</label>
                                    <div v-if="itemCarta.Id == null" class="col-sm-12">
                                ...
                                <label class="col-sm-12 control-label">Tiempo aprox. entrega</label>
                                    <div class="col-sm-12">
        ...
        <div class="modal fade" id="modalFoto" tabindex="-1" role="dialog" aria-labelledby="modalCategoriasCartaTitle" aria-hidden="true">
            <div class="modal-dialog  modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalItemsFoto">Fotografía de {{itemSeleccionado.Nombre_item}}</h5>
                        <button type="button" class="Cerrar" data-dismiss="modal" aria-label="Cerrar">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p align="center">
                            <img v-if="itemSeleccionado.Imagen != null" class="avatar_grande" v-bind:src="'<?php echo base_url(); ?>uploads/imagenes/'+itemSeleccionado.Imagen" alt="">
                        ...
                        <div class="horizontal-form">
                            ...
                            <form class="form-horizontal" action="post" enctype="multipart/form-data" v-on:submit.prevent="uploadItem(itemSeleccionado.Id)">
                                <div class="form-group">
                                    <p>Nueva imagen</p>
                                    <div class="col-sm-10">
