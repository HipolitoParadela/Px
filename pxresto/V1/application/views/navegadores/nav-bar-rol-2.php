            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo base_url(); ?>restaurant/comandas"><i class="ti-write"></i>  Comandas en proceso</a></li>
                        <li><a href="<?php echo base_url(); ?>restaurant/resumencomandas"><i class="ti-layers-alt"></i>  Resumen de comandas</a></li>
