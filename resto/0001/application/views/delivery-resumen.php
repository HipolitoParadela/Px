                                        ...
                                        <table id="table2excel" class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr v-for="Delivery in listaDeliverysCerrados">
                                                    ...
                                                    <td>{{Delivery.Nombre_repartidor}}</td>
                                                    <td>{{Delivery.Descripcion}}</td>
                                                    <td>{{Delivery.FechaHora_pedido | FechaTimestampBaseDatos}}</td>
                                                    <td align="right"><span class="text-info">${{Delivery.Valor_cuenta}}</span></td>
                                                    <td align="right"><span class="text-danger">${{Delivery.Valor_descuento}}</span></td>
                                                    <td align="right"><span class="text-success">${{Delivery.Valor_cuenta - Delivery.Valor_descuento}}</span></td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <td colspan="5"></td>
                                                    <td align="right">
                                                        <h4><span class="text-info">${{sumarCuenta(listaDeliverysCerrados)}}</span></h4>
                                                    </td>
                                                    <td align="right">
                                                        <h4><span class="text-danger">${{sumarDescuentos(listaDeliverysCerrados)}}</span></h4>
                                                    </td>
                                                    <td align="right">
                                                        <h4><span class="text-success">${{sumarCuenta(listaDeliverysCerrados) - sumarDescuentos(listaDeliverysCerrados)}}</span></h4>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
