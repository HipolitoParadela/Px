                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <button class="btn btn-success btn-flat btn-addon m-b-10 m-l-5" data-toggle="modal" data-target="#stockmodal" v-on:click="limpiarFormularioStock()">
                                                <i class="zmdi zmdi-plus"></i>Nuevo item</button>

                                            <button class="btn btn-info btn-flat btn-addon m-b-10 m-l-5" data-toggle="modal" data-target="#categoriaModal" v-on:click="limpiarFormularioCategoria()">
                                ...
                                <div class="modal-body">
                                    <div class="horizontal-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            Si <input type="radio" name="Apto_carta" value="1" v-model="stockDato.Apto_carta">
                                            No <input type="radio" name="Apto_carta" value="0" v-model="stockDato.Apto_carta">
                                        </div>
                                        <div v-show="stockDato.Apto_carta == 1" class="form-group">
                                        ...
                                        <div v-show="stockDato.Apto_carta == 1" class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                Si <input type="radio" name="Apto_delivery" value="1" v-model="stockDato.Apto_delivery">
                                                No <input type="radio" name="Apto_delivery" value="0" v-model="stockDato.Apto_delivery">
                                            </div>
                                        </div>
