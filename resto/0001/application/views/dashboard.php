        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <section id="main-content">
                    ...
                    <?php if($this->session->userdata('Rol_id') > 3) { echo ''; /// inicio condicional para Roles PHP ?>
                    <div class="row">
                        <div class="col-lg-3">
                                <div class="card">
                    ...
                    <?php   '';} /// fin condicional para Roles PHP?>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="card">
                                <div id="fb-root"></div>
                                    ...
                                    <div class="fb-page" data-href="https://www.facebook.com/acanomassl" data-tabs="timeline" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                                        <blockquote cite="https://www.facebook.com/acanomassl" class="fb-xfbml-parse-ignore">
                                            <a href="https://www.facebook.com/acanomassl">Px Restó</a>
                                        </blockquote>
                                    </div>
                            </div>
                            <!-- <div class="card">
