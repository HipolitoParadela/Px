...
var carpeta = '/resto/hungrydonuts/' /// carpeta que hay q modificar segun cliente
...
new Vue({
    ...
    data: 
    {
        ...
        itemsCarta: [],
        itemCarta: { 'Id': '', 'Categoria_id': '', 'Apto_delivery': '', 'Nombre': '', 'Imagen': '', 'Descripcion': '', 'Precio': '', 'Tiempo_estimado_entrega': '', 'Activo': '1'},
        itemFoto: { 'Id': '', 'Nombre': '', 'Imagen': '' },
        ...
        delivery: { 'Id': '', 'Repartidor_id': '', 'FechaHora_pedido': '', 'FechaHora_salidarepartidor': '', 'Nombre_cliente': '', 'Direccion': '', 'Telefono': '', 'Cuenta': '', 'Descuento': '', 'Estado': '' },
    ...
    methods:
    {
        ...
        //// MOSTRAR LISTADO DE ITEMS DE LA CARTA    
        ...
        //// ACTIVAR/DESACTIVAR ITEMS DE LA CARTA    
        ...
        //// LIMPIAR EL FORMULARIO DE CREAR ITEMS CARTA    
            limpiarFormularioItems()
            {
                this.itemCarta.Id = '';
                this.itemCarta.Categoria_id = '';
                this.itemCarta.Nombre = '';
                this.itemCarta.Imagen = '';
                this.itemCarta.Descripcion = '';
                this.itemCarta.Precio = '';
                this.itemCarta.Tiempo_estimado_entrega = '';

                this.texto_boton = "Cargar";
            },

        //// Carga el formulario ITEMS CARTA para editar
        ...
        //// CREAR O EDITAR ITEMS DE LA CARTA
            crearItem: function () 
            {       
                var url = base_url +'restaurant/cargarItem'; // url donde voy a mandar los datos
        ...
        //// LIMPIAR EL FORMULARIO DE CREAR Categorias CARTA    
        ...
        //// Carga el formulario cATEGORIAS para editar
        ...
        //// MOSTRAR LISTADO DE CERRADAS
            comandasEntreFechas: function () 
            {
                ...
                axios.post(url, { Desde: this.fecha_desde, Hasta: this.fecha_hasta}).then(response => {
        ...
        //// MOSTRAR LISTADO DE DELIVERYS A LA FECHA
    ...
    methods:
    {
        ...
        //// Hora de entregas en mesa
            entregasEnMesa: function (Comanda_id, tipo, valorCuenta) {
                ...
                axios.post(url, {
                    Comanda_id: Comanda_id, Tipo: tipo, ValorCuenta : valorCuenta
                }).then(response => {
            ...
            sumarCuenta: function (items) 
            {
                //// SUMAR LOS ENTREGADOS
                    ...
                    for (var i = 0; i < items.Entregados.length; i++) 
                    {
                        ...
                        if (isFinite(items.Entregados[i].Precio)) {
                            item = parseInt(items.Entregados[i].Precio);
                        }
                    ...
                    for (var i = 0; i < items.Pendientes.length; i++) 
                    {
                        ...
                        if (isFinite(items.Pendientes[i].Precio)) {
                            item = parseInt(items.Pendientes[i].Precio);
                        }
...
new Vue({
    ...
    data: {
        ...
        Delivery: '',
        datoDelivery: {},
        itemDelivery: { 'Id': '', 'Delibery_id': '', 'Item_id': '' },
            ...
            //// SUMAR CUENTA   
                sumarCuenta: function (items) 
                {
                    ...
                    for (var i = 0; i < items.length; i++) 
                    {
                        ...
                        if (isFinite(items[i].Precio)) 
                        {
                            item = parseInt(items[i].Precio);
                        }
                    Total = Total + item;
                    }
                    return Total
...
new Vue({
    ...
    data: {
        ...
        itemsCarta: [],
        //itemCarta: { 'Id': '', 'Categoria_id': '', 'Nombre': '', 'Imagen': '', 'Descripcion': '', 'Precio': '', 'Tiempo_estimado_entrega': '', 'Activo': '1' },
        valorVentasHoy:     '',
        valorVentasAyer:    '',
        valorVentasMes:     '',
        valorVentasAnio:    '',
    ...
    methods:
        {
            ...
            //// MOSTRAR LISTADO DE SUELDOS
                getSueldos: function () 
                {
                    var url = base_url + 'usuarios/obtener_sueldos/?Id=' + Get_Id;  //// averiguar como tomar el Id que viene por URL aca
