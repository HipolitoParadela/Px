                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{proveedoresDatos.Nombre_item}}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="user-photo m-b-30">
                                                <img class="img-fluid" v-if="proveedoresDatos.Imagen != null" v-bind:src="'<?php echo base_url(); ?>uploads/imagenes/'+proveedoresDatos.Imagen" alt="">
