                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <select class="form-control" v-model="Filtro_periodo" v-on:change="getListadoCompras(filtro_rubro, null, null, Filtro_periodo)">
                ...
                <form class="form-horizontal" action="post" v-on:submit.prevent="crearCompra()">
                    <div class="modal-body">
                        <div class="horizontal-form">
                            ...
                            <div class="form-group">
                                <label class=" form-control-label">Periodo en el que se realizó la compra</label>
                                <select class="form-control" v-model="compraDatos.Periodo_id" required>
                                    <option value="0">No asignar periodo</option>
                                    <option v-for="periodo in listaPeriodos.Datos" v-bind:value="periodo.Id">{{periodo.Identificador}}</option>
                                </select>
                            </div>
                            <div class="form-group">
