                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow" v-for="producto in buscarProducto">
                                                ...
                                                <td class="text-right"><h4>$ {{producto.Precio_costo | Moneda}}</h4></td> 
                                                <td class="text-right"><h4>${{(producto.Precio_costo * 2.2) | Moneda}}</h4></td>
                                                <td><span class="block-email">{{producto.Nombre_categoria}}</span></td>
                                                <td>{{producto.Ultima_actualizacion | FechaTimestampBaseDatos}}</td>
                        ...
                        <form class="form-horizontal" action="post" v-on:submit.prevent="crearProducto()">
                            <div class="modal-body">
                                <div class="horizontal-form">
                                    ...
                                    <div class="form-group">
                                        <label class=" form-control-label">Unidad de venta de este producto</label>
                                        <input type="text" class="form-control" placeholder="" v-model="productoDatos.Unidad_venta">
                                    </div>
                                    <div class="form-group">
                                        <label class=" form-control-label">Precio Costo</label>
                                        <input type="number" class="form-control" placeholder="" v-model="productoDatos.Precio_costo">
                                    </div>
                                    <div class="form-group">
                                        <label class=" form-control-label">Precio costo aprox. en Dolares</label>
                                        <input type="number" step=".01" class="form-control" placeholder="" v-model="productoDatos.Precio_USD">
                                    </div>
                                    <div class="form-group">
                                        <label  class=" form-control-label">Descripción Pública Corta</label>
                                        <textarea class="form-control" rows="2" placeholder="" v-model="productoDatos.Descripcion_publica_corta"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label  class=" form-control-label">Descripción Pública Larga (HTML)</label>
                                        <textarea class="form-control" rows="2" placeholder="" v-model="productoDatos.Descripcion_publica_larga"></textarea>
                                    </div>                                    
                                    <div class="form-group">
                                        <label class="control-label">Descripción privada</label>
                                        <textarea class="form-control" rows="2" placeholder="" v-model="productoDatos.Descripcion_tecnica_privada"></textarea>
                                    </div>
                                </div>
                            </div>
