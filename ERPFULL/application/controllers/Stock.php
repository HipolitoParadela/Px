...
//// MOVIMIENTOS 	| OBTENER MOVIMIENTOS DE UN STOCK v2
    public function obtener_movimientos_v2()
    {
        ...
        $Id = $_GET["Id"];
        $Tipo_movimiento = $this->datosObtenidos->Tipo_movimiento; // 1 Equivale a compras, 2 a VENTAS
        $Mostrar_reventas = $this->datosObtenidos->Mostrar_reventas; // 1 Equivale a compras, 2 a VENTAS
        ...
        {    /// consulta desde VENTAS
            ...
            if($Mostrar_reventas == 1)
            {
                $this->db->where('tbl_stock_movimientos.Mostrar_reventas', 0); /// si es 0 o 1 el producto es insumo, si es 2, es de reventa.
            }
            else if($Mostrar_reventas == 2)
            {
                $this->db->where('tbl_stock_movimientos.Mostrar_reventas', 2); /// si es 0 o 1 el producto es insumo, si es 2, es de reventa.
            }
...
//// MOVIMIENTOS 	| CARGAR NUEVO MOVIMIENTO V2
    public function cargar_movimiento()
    {
        ...
        $Mostrar_reventas = $this->datosObtenidos->Mostrar_reventas;
        ...
        $data = array(
            ...
            'Mostrar_reventas'      => $Mostrar_reventas,
